...
# Player Queues
## This webpage focuses on utilizing Monte Carlo Simulation to simulate a Video-Game Queueing System. Random amount of party sizes containing 1 to 5 players are produced and introduced to the queue. The objective is to form groups of 5 in order to begin a game. Through the queueing system, I am trying to find the most efficient and effective way to form these groups.
